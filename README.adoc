...
The different sections linked by this document describe the installation 
 process for OCP 4.16.x on different platforms.
...
Considerations regarding DNS: https://docs.redhat.com/en/documentation/openshift_container_platform/4.16/html/installing_on_any_platform/installing-platform-agnostic#installation-dns-user-infra_installing-platform-agnostic
...
[source,bash]
----
ansible-playbook ocp/ansible/50-ocp-services-get-ocp-auth-playbook.yaml \
